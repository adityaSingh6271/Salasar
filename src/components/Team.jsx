  ...
  return (
    <div className="mt-25">
      <section className="flex flex-col items-center w-full px-4 md:px-20 py-12">
        ...
        >
          “Our team is a group of dedicated real estate professionals committed
          to helping clients buy, sell, and invest with confidence. With
          expertise in market trends, property management, and client care, we
          work collaboratively to deliver personalized solutions and exceptional
