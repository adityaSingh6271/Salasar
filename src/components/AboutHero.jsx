  ...
  return (
        <div className="relative min-h-screen bg-white overflow-hidden">
          ...
          <div className="relative h-[80vh]">
            ...
            <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-10 text-center text-white px-4 sm:px-6 lg:px-8">
              <div className="w-full max-w-5xl mx-auto space-y-4 sm:space-y-6 lg:space-y-8 mb-20">
                ...
                >
                  Craft identities that echo through eternity — strong and luminous. From
                  projects to homes, our artisans build with grace and wonder. Lay your
                  foundation of magic with Salasar Builders.
                </p>
              </div>
            </div>
          </div>
